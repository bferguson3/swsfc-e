...
words.append(TLWord(0x2cc35, 4, "Square "))
...
words.append(TLWord(0x2cc77, 4, "Square "))
...
words.append(TLWord(0x2cc98, 6, "Aqueduct "))
...
words.append(TLWord(0x985f, 7, "Heal HP"))
...
words.append(TLWord(0x9945, 10, "Ammo for bows"))
...
words.append(TLWord(0x3824b, 23, "A Myrii Guard will be\x012000 gamels."))
...
words.append(TLWord(0xbed0, 23, "Buy weapons\x01Buy shields\x01Buy armor"))
...
words.append(TLWord(0x1a799, 8, "Paralyze foe "))
...
words.append(TLWord(0x1aaf7, 10, "Cause confusion"))
...
words.append(TLWord(0x1da31, 31, " began dancing, \x01and most spells \x01are now disabled"))
