...
words.append(TLWord(0x29959, 8, "  Grassrunn"))
...
words.append(TLWord(0x6794, 8,  "  Grassrunn"))
...
words.append(TLWord(0x2cc27, 7, "FallsTempl"))
...
words.append(TLWord(0x98a8, 13, "Adds 1 to dexterity"))
...
words.append(TLWord(0xa2d3, 9, "'s dexterity"))
words.append(TLWord(0xb8f5, 8, "'s dexterity"))
...
words.append(TLWord(0xb98f, 8, "'s dexterity\x01"))
...
words.append(TLWord(0x67f6, 6, "No skills"))
...
words.append(TLWord(0xc077, 5, "1H Swd"))
...
words.append(TLWord(0xc094, 5, "2H Swd"))
...
words.append(TLWord(0xc7ca, 11, " skill will be used."))
words.append(TLWord(0xc899, 14, " skill restricts this."))
...
words.append(TLWord(0x1a1b0, 7, "ChaosFlute"))
...
words.append(TLWord(0x1a248, 34, "Disables all magic besides \x01holy magic and common runes."))
...
words.append(TLWord(0x1a751, 10, "Fires electricity"))
words.append(TLWord(0x1a75c, 11, "Turn invisible "))
words.append(TLWord(0x1a768, 25, "Finds what spirits \x01are active here "))
words.append(TLWord(0x1a782, 22, "Creates an explosion \x01causing damage"))
...
words.append(TLWord(0x1ab6b, 16, "Heals wounds\x01(Fem only)"))
