...
words.append(TLWord(0xb43c, 19, " will level to\x01\x0f . This OK ?"))
...
words.append(TLWord(0x9757, 5, "Ransom "))
...
words.append(TLWord(0x1aaa7, 25, "Disrupts focus,\x01disabling magic "))
