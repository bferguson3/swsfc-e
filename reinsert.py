...
words.append(TLWord(0x29965, 13, "Half-Elf  (Hu)   "))
words.append(TLWord(0x29973, 7, "  (Elf) "))
...
words.append(TLWord(0x388c6, 37, "Buy magic item \x01Buy mage staff \x01Buy common rune"))
words.append(TLWord(0x388f7, 26, "Enchanted Rune \x01Protect Rune \x01Defense Rune "))
words.append(TLWord(0x38918, 8, "Enchanted Rune "))
...
words.append(TLWord(0xdab8, 15, "With Rahda's wisdom."))
words.append(TLWord(0xdaff, 10, "Can I help?"))
words.append(TLWord(0xdb0a, 22, "Go with the protection \x01of Cha-Za."))
...
words.append(TLWord(0xdaaa, 14, "With Rahda's wisdom."))
...
words.append(TLWord(0x1f76e, 12, "Can't carry any more."))
